...
export const routes: Routes = [
...

  {
    ...
    children: [
      ...
      { path: 'clients', loadComponent: () => import('./pages/platform/clients/platform-clients.page').then(m => m.PlatformClientsPage) },
      { path: 'subscriptions', loadComponent: () => import('./pages/platform/subscriptions/platform-subscriptions.page').then(m => m.PlatformSubscriptionsPage) },
      { path: 'plans', loadComponent: () => import('./pages/platform/plans/platform-plans.page').then(m => m.PlatformPlansPage) },
      { path: 'reset-password', loadComponent: () => import('./pages/platform/reset-password/reset-password.page').then(m => m.PlatformResetPasswordPage) }
    ]
  },

  {
    ...
    children: [
      ...
      { path: 'clients', loadComponent: () => import('./pages/tenant/clients/tenant-clients.page').then(m => m.TenantClientsPage) },
      { path: 'categories', loadComponent: () => import('./pages/tenant/categories/tenant-categories.page').then(m => m.TenantCategoriesPage) },
      { path: 'products', loadComponent: () => import('./pages/tenant/products/tenant-products.page').then(m => m.TenantProductsPage) },
      { path: 'orders', loadComponent: () => import('./pages/tenant/orders/tenant-orders.page').then(m => m.TenantOrdersPage) },
      { path: 'orders/:venta_id', loadComponent: () => import('./pages/tenant/orders/tenant-order-detail.page').then(m => m.TenantOrderDetailPage) },
